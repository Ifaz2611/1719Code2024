...
public class AutoMovePIDCommanded extends PIDCommand {
  /** Creates a new AutoMovePIDCommanded. */

  public AutoMovePIDCommanded(double direction, double distance, double initialDist, SwerveSubsystem m_swerve) {
    super(
