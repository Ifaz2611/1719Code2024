...
public class ShootSequence extends SequentialCommandGroup {
  ...
  public InstantCommand ShooterMotors (int direction) {
    return new InstantCommand(()->mDeviceSubsystem.turnShooterMotors(direction));
  }
  ...
  public ShootSequence(DeviceSubsystem mDeviceSubsystem) {
    ...
    addCommands(ShooterMotors(1),waitwait(3), IntakeMotors(1), waitwait(2), IntakeMotors(0), ShooterMotors(0));
  }
}
